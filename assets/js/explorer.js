...
function renderDirectoryGrid() {
    ...
    const attachBalloonInteractions = (wrapperEl) => {
        ...
        // Tap/Click manual pada tombol info untuk toggle balloon popup
    ...
    // Render Media Stream Cards
    mediaItems.forEach(media => {
        const mediaCard = document.createElement("div");
        mediaCard.className = "grid-card media-card";
        ...
        gridExplorer.appendChild(mediaCard);
        count++;
    });
